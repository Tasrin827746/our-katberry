...
const Projects1: React.FC<ProjectModalGalleryProps> = ({
  ...
  >
    <div
      className="bg-gray-200 p-4 rounded-lg max-w-6xl w-full max-h-[90vh] overflow-auto relative z-60"
      onClick={(e) => e.stopPropagation()} 
    >
      <button
        className="absolute top-2 right-2 text-gray-700 hover:text-gray-900 text-3xl font-bold z-70"
        onClick={() => setActiveImage(null)}
      >
        &times;
      </button>
